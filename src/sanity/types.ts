...
// Query: *[_type == "startup" && _id == $id][0] {  _id,  title,  slug,  category,  _createdAt,  author -> {    _id,    name,    username,    image,    bio  },  views,  description,  image,  pitch}
...
// Query: *[_type == "playlist" && slug.current == $slug][0] {    _id,     title,     slug,    select[] -> {      _id,      title,      slug,_id,  title,  slug,  category,  _createdAt,  author -> {    _id,    name,    username,    image,    bio  },  views,  description,  image,  pitch,  category,  _createdAt,  author -> {    _id,    name,    username,    image,    bio    },  views,  description,  image,  pitch  }}
